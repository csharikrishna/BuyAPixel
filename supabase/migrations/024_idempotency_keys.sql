-- ============================================================================
-- 024: IDEMPOTENCY KEYS FOR PAYMENTS
-- BuyAPixel - Prevent duplicate payment processing
-- ============================================================================

-- ============================================================================
-- ADD IDEMPOTENCY KEY TO PAYMENT ORDERS
-- Ensures same payment verification request doesn't get processed twice
-- ============================================================================
