-- =============================================================
-- Migration: Update active_advertisers count
-- =============================================================
-- Updates get_platform_stats to calculate active_advertisers based 
-- on the number of unique projects in vw_project_leaderboard 
-- instead of unique user profiles.
-- =============================================================
...
BEGIN
  SELECT json_build_object(
    ...
    -- Updated to count unique projects instead of just user accounts
    'active_advertisers', (SELECT COUNT(*) FROM public.vw_project_leaderboard),
